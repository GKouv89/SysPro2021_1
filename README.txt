...
Επιλογές:
  [] Το πρόγραμμα κάνει πολύ βασικούς ελέγχους για το input. 
    ...
    popStatus και popStatusByAge (εκεί εξασφαλίζεται και το ότι η 2η ημερομηνία είναι μεταγενέστερη της 
    ...
    Το πρόγραμμα ελέγχει για εγγραφές με NO αν έχουν ημερομηνία μετά και τις απορρίπτει, όμως θεωρεί θέσφατο ότι οι εγγραφές με YES 
    έχουν ημερομηνία.
  ...
  [] Το skiplist έχει υλοποιηθεί ως συστάδα λιστών. Κάθε κόμβος σε κάθε επίπεδο έχει ένα ID και έναν δείκτη σε char
  ...
  [] Η έννοια του μη εμβολιασμένου διαφέρει μεταξύ των διαφόρων commands του προγράμματος.
    ...
    [] Στις εντολές popStatus, popStatusByAge, list-nonVaccinated-Persons, ο πολίτης θεωρείται μη εμβολιασμένος αν περιέχεται
    ρητά στην skiplist μη εμβολιασμένων του ιού.
  [] Ο τύπος για τον υπολογισμό των ποσοστών στις popStatus, popStatusByAge είναι ο εξής:
...
Bash Script:
  ...
  generate τόσα ψηφία όσα υπαγορεύει το μήκος.
